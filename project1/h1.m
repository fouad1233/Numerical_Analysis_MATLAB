...
[l_a_it_b,l_b_it_b,l_p_it_b,l_fp_it_b] = bisection(lpoli_f,[2,3],20);
lpoli_f_bis_t = table(l_a_it_b.',l_b_it_b.',l_p_it_b.',l_fp_it_b.');
l_poli_bis_err  =( l_b_it_b(end) - l_a_it_b(end)) / 2;

[l_p_it_f , l_fp_it_f] = fixed_point(lpoli_f,2.5,20);
lpoli_f_fixed_t = table(l_p_it_f.',l_fp_it_f.');

[l_p_it_n , l_fp_it_n] = newton_raphson(lpoli,2.5,6);
lpoli_f_newtonr_t = table(l_p_it_n.',l_fp_it_n.');
[l_raph_error ,l_raph_error_func] = calculate_newton_raphson_error...
(lpoli , l_p_it_n(end-1) , l_p_it_n(end), [2.4 , 2.5]);

[l_p_it_s , l_fp_it_s] = secant_method(lpoli_f,2,3,20);
lpoli_f_secant_t = table(l_p_it_s.',l_fp_it_s.');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
npoli_f = matlabFunction(npoli);
[n_a_it_b,n_b_it_b,n_p_it_b,n_fp_it_b] = bisection(npoli_f,[2,3],20);
npoli_f_bis_t = table(n_a_it_b.',n_b_it_b.',n_p_it_b.',n_fp_it_b.');
npoli_bis_err  =( n_b_it_b(end) - n_a_it_b(end)) / 2;

[n_p_it_b , n_fp_it_b] = fixed_point(npoli_f,2.5,20);
npoli_f_fixed_t = table(n_p_it_b.',n_fp_it_b.');

[n_p_it_n , n_fp_it_n] = newton_raphson(npoli,2.5,4);
npoli_f_newtonr_t = table(n_p_it_n.',n_fp_it_n.');
[n_raph_error ,n_raph_error_func] = calculate_newton_raphson_error(lpoli , n_p_it_n(end-1) , n_p_it_n(end), [2.4 , 2.5]);

[n_p_it_s , n_fp_it_s] = secant_method(npoli_f,2,3,20);
...
[f_a_it_b,f_b_it_b,f_p_it_b,f_fp_it_b] = bisection(fx_poli_f,[2,3],20);
